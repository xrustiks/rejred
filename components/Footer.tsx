...
export default function Footer() {
  ...
  return (
    <footer className="bg-sky-700 text-white mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div>
            ...
            >
              ...
              <li><a href="/support" className="text-sky-100 hover:[color:var(--primary)]">Support & Resources</a></li>
              <li><a href="/about" className="text-sky-100 hover:[color:var(--primary)]">Author</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            >
              ...
              <li><a href="https://calendly.com/valerusu55" className="text-sky-100 hover:text-white">Calendly</a></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-sky-600 mt-8 pt-8 text-center text-sky-100">
