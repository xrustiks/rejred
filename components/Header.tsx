      ...
      <nav className={`container mx-auto px-4 ${scrolled ? 'py-3' : 'py-6 md:py-8'} transition-[padding] duration-300`}>
        <div className="flex items-center justify-between">
          ...
          <ul className="hidden md:flex items-center gap-10">
            <li>
              <Link href="/" className={`text-gray-700 hover:[color:var(--primary)] transition-colors ${scrolled ? 'text-base' : 'text-lg md:text-xl'} font-medium`}>
                Home
              </Link>
            </li>
            <li>
              <Link href="/podcasts" className={`text-gray-700 hover:[color:var(--primary)] transition-colors ${scrolled ? 'text-base' : 'text-lg md:text-xl'} font-medium`}>
                Podcasts
              </Link>
            </li>
            <li>
              <Link href="/videos" className={`text-gray-700 hover:[color:var(--primary)] transition-colors ${scrolled ? 'text-base' : 'text-lg md:text-xl'} font-medium`}>
                Videos
              </Link>
            </li>
            <li>
              <Link href="/photos" className={`text-gray-700 hover:[color:var(--primary)] transition-colors ${scrolled ? 'text-base' : 'text-lg md:text-xl'} font-medium`}>
                Photos
              </Link>
            </li>
            <li>
              <Link href="/about" className={`text-gray-700 hover:[color:var(--primary)] transition-colors ${scrolled ? 'text-base' : 'text-lg md:text-xl'} font-medium`}>
                About
              </Link>
            </li>
          </ul>
